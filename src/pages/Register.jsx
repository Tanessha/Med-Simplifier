...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      toast.success("Registration successful! Welcome to Med Simplifier.");
      navigate("/quiz"); // Send directly to literacy quiz
    } catch (err) {
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-slate-300 bg-white shadow-xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-slate-600">Enter your details below to create your account</CardDescription>
          </CardHeader>
          <form onSubmit={handleRegister}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="text-sm text-center text-slate-600">
                ...
                <Link to="/login" className="font-medium text-sky-700 hover:text-sky-800 hover:underline">
                  Login
                </Link>
              </div>
            </CardFooter>
